...
function renderTodos(todos) {
    todoContainer.innerHTML = ""; // clear the todo container first then push all the todos
    for (let todo of todos) {
        ...
        //todoContainer.innerHTML = ""; // this is logically wrong, it will clear every time you add a new todo
